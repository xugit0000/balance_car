...
extern float g_pitch,g_roll,g_yaw;       //欧拉角:俯仰角，偏航角，滚转角
extern short g_aacx,g_aacy,g_aacz;       //加速度传感器原始数据  angular acceleration
extern short g_gyrox,g_gyroy,g_gyroz;    //陀螺仪原始数据  gyroscope
extern short g_temp;                     //陀螺仪温度
